...
export function ModelSelector({ models, onSelect, className, disabled }: ModelSelectorProps) {
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="min-w-[220px]">
        ...
        {models.map((model, index) => (
          <DropdownMenuItem key={index} onClick={() => onSelect(index)} className="justify-between">
