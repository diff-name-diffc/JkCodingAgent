...
mod tests {
    ...
    use super::super::super::db::{
        ChecklistStepStatus, DispatcherDb, DispatcherMode, DispatcherSessionKind,
    };
    use super::super::super::tools::parse_update_plan;
    use super::*;
    ...
    async fn checklist_dispatch_lifecycle_reserves_starts_and_completes_step() {
        ...
        let reserved = reserve_checklist_dispatch(
            &db,
            &session.id,
            "dispatch-1",
            "claude",
