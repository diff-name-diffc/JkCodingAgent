...
pub async fn generate_image(
    ...
    save_and_return(image_bytes.to_vec(), session_id, session_title, input, &model, width, height).await
}
...
async fn save_and_return(
    ...
    let ext = "png";
    let file_path = images_dir.join(format!("{}.{}.{}", session_id, image_id, ext));
