...
pub fn run() {
    tauri::Builder::default()
        ...
        // 聊天图片唯一服务出口：`chat-image://{image_id}` 自定义协议，
        // <img src> 直接引用，前端不再有 invoke resolve 两阶段渲染。
        .register_asynchronous_uri_scheme_protocol(
            "chat-image",
            chat_images::handle_chat_image_scheme,
        )
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            browser::commands::browser_start,
            browser::commands::browser_start_plain_chat,
            browser::commands::browser_import_chrome_profile,
            browser::commands::browser_list_chrome_profile_candidates,
            browser::commands::browser_stop,
            python_runner::commands::python_runner_list_results,
            python_runner::commands::python_runner_start,
            python_runner::commands::python_runner_stop,
            python_runner::commands::python_runner_clear_result,
            ...
            browser::commands::browser_click_at,
            browser::commands::browser_go_back,
            browser::commands::browser_navigate,
            browser::commands::browser_reload,
            browser::commands::browser_get_status,
            browser::commands::browser_minimize,
            browser::commands::browser_restore,
            browser::commands::browser_reopen,
            chat_images::save_chat_image,
            chat_images::chat_images_validate,
            ...
            scm::git::commit_message::generate_commit_message,
            scm::git::queries::git_status,
            scm::git::queries::git_list_branches,
            scm::git::mutations::git_create_branch,
            scm::git::mutations::git_checkout_branch,
            scm::git::queries::git_log,
            scm::git::queries::git_commit_detail,
            scm::git::diffs::git_diff,
            scm::git::mutations::git_stage,
            scm::git::mutations::git_unstage,
            scm::git::mutations::git_stage_all,
            scm::git::mutations::git_unstage_all,
            scm::git::mutations::git_commit,
            scm::git::mutations::git_push,
            scm::git::mutations::git_pull,
            scm::git::queries::git_remote_counts,
            ...
            ssh_tool::commands::ssh_tool_load_config,
            ssh_tool::commands::ssh_tool_load_audit,
            ssh_tool::commands::ssh_tool_save_config,
            ssh_tool::commands::ssh_tool_test_server_config,
            ...
            agent::commands::message_commands::dispatcher_clear_messages,
            agent::commands::message_commands::dispatcher_truncate_messages_from,
            agent::commands::message_commands::dispatcher_get_tool_artifact,
            agent::commands::session_commands::chat_list_sessions,
            agent::commands::session_commands::chat_create_session,
            agent::commands::session_commands::chat_delete_session,
            agent::commands::session_commands::chat_set_session_category_v6,
            agent::commands::session_commands::project_list_sessions,
            agent::commands::session_commands::project_create_session,
            agent::commands::session_commands::project_delete_session,
            agent::commands::session_commands::session_search_keywords,
            agent::commands::category_commands::chat_list_categories,
            agent::commands::category_commands::chat_create_category,
            agent::commands::category_commands::chat_update_category,
            agent::commands::category_commands::chat_delete_category,
            agent::commands::settings_commands::aha_get_settings_v2,
            agent::commands::settings_commands::aha_save_settings_v2,
            agent::commands::category_commands::aha_get_chat_category_agent_configs,
            agent::commands::category_commands::aha_save_chat_category_agent_configs,
            agent::commands::settings_commands::aha_list_agent_tools,
            agent::commands::model_commands::dispatcher_fetch_models,
            agent::commands::model_commands::dispatcher_test_model,
            agent::commands::settings_commands::dispatcher_stop_run,
