...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspace::fs::read_binary_file,
            workspace::fs::read_dwg_file_snapshot,
            ...
            agent::commands::dispatcher_delete_pending_attachment,
            agent::commands::dispatcher_get_dwg_parse_cache,
            agent::commands::dispatcher_save_dwg_parse_cache,
            agent::commands::dispatcher_get_dwg_document_record,
            agent::commands::dispatcher_upsert_dwg_document_index,
            agent::commands::dispatcher_upsert_dwg_entity_payloads,
            agent::commands::dispatcher_list_cad_review_runs,
            agent::commands::dispatcher_get_cad_review_run_detail,
            agent::commands::dispatcher_get_tool_artifact,
            agent::commands::dispatcher_register_dwg_viewer_session,
            agent::commands::dispatcher_unregister_dwg_viewer_session,
            agent::commands::dispatcher_update_dwg_viewer_state,
            agent::commands::dispatcher_resolve_dwg_viewer_command,
